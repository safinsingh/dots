...
" Palette: {{{
let s:palette = {
      \ 'bg0':        ['#050810',   '235',  'Black'],
      \ 'bg1':        ['#101933',   '236',  'DarkGrey'],
      \ 'bg2':        ['#101933',   '237',  'DarkGrey'],
      \ 'bg3':        ['#101933',   '238',  'DarkGrey'],
      \ 'bg4':        ['#050810',   '239',  'Grey'],
      \ 'bg_red':     ['#cdb4ca',   '52',   'DarkRed'],
      \ 'bg_green':   ['#bfcfbc',   '22',   'DarkGreen'],
      \ 'bg_blue':    ['#b1c2d7',   '17',   'DarkBlue'],
      \ 'fg':         ['#edf0f8',   '223',  'White'],
      \ 'red':        ['#ad779b',   '167',  'Red'],
      \ 'orange':     ['#ad779b',   '208',  'Red'],
      \ 'yellow':     ['#ad937f',   '214',  'Yellow'],
      \ 'green':      ['#90af7f',   '108',  'Green'],
      \ 'cyan':       ['#74af9b',   '108',  'Cyan'],
      \ 'blue':       ['#7493b8',   '109',  'Blue'],
      \ 'purple':     ['#9077b8',   '175',  'Magenta'],
      \ 'grey':       ['#18264d',   '245',  'LightGrey'],
      \ 'light_grey': ['#18264d',   '245',  'LightGrey'],
      \ 'gold':       ['#ad937f',   '214',  'Yellow'],
      \ 'none':       ['NONE',      'NONE', 'NONE']
      \ }
" }}}
" Function: {{{
